...
class UpdateEmailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button_authenticate.setOnClickListener {
            val pwd = edit_text_password.text.toString().trim()
            if (pwd.isEmpty()) {
                edit_text_password.error = "Passsword required"
                edit_text_password.requestFocus()
                return@setOnClickListener
            }

            //If pwd is non emoty then check
            //whether the entered pwd is correct or not
            //To do that we need to create Credential instance
        ...
        button_update.setOnClickListener { updateBtnView ->
            ...
            if(!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                edit_text_email.error = "Enter Valid Email ID"
                edit_text_email.requestFocus()
                return@setOnClickListener
            }
                ...
                user.updateEmail(email)
                    .addOnCompleteListener { task ->
                        ...
                        if(task.isSuccessful){
                            ...
                            Navigation.findNavController(updateBtnView).navigate(action)
